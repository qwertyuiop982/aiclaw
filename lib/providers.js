...
const GENERIC_PROVIDERS = [
  { key: 'openai-generic', label: 'OpenAI 通用', protocol: 'openai', baseURL: 'https://example.com/v1/chat/completions', models: [], thinking: 'reasoning-effort', effortLevels: ['low', 'medium', 'high'], notes: 'OpenAI-compatible: POST /v1/chat/completions' },
  { key: 'anthropic-generic', label: 'Anthropic 通用', protocol: 'anthropic', baseURL: 'https://example.com/anthropic', models: [], thinking: 'reasoning-effort', effortLevels: ['low', 'medium', 'high'], notes: 'Anthropic Messages API' },
  { key: 'google-generic', label: 'Google 通用（Gemini）', protocol: 'google', baseURL: 'https://example.com/v1beta/models/{model}:generateContent', models: [], thinking: 'reasoning-effort', effortLevels: ['low', 'medium', 'high'], notes: 'Gemini generateContent API; native tool calling' },
];
const PROVIDERS = [
  ...GENERIC_PROVIDERS,
  {
